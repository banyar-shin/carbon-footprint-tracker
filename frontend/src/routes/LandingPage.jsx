...
export default function LandingPage() {
  return (
    <div className="flex flex-col h-screen w-full items-center justify-center text-center text-base-content bg-base-300 p-4">
      {/* Hero Section */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-4xl ">
        <Link to="/dashboard/transport" className="bg-base-100 shadow-md rounded-lg p-6 hover:bg-base-200 transition duration-300 ease-in-out hover:scale-105">
        ...
        <Link to="/dashboard/energy" className="bg-base-100 shadow-md rounded-lg p-6 hover:bg-base-200 transition duration-300 ease-in-out hover:scale-105">
        ...
        <Link to="/dashboard/diet" className="bg-base-100 shadow-md rounded-lg p-6 hover:bg-base-200 transition duration-300 ease-in-out hover:scale-105">
