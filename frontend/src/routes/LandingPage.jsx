  ...
  return (
    <div className="flex flex-col h-screen w-full items-center justify-center text-center text-base-content bg-base-100 p-4">
      ...
      <div className="w-full flex justify-center mb-4">
        <Link to="/dashboard">
          <button className="btn bg-gradient-to-r from-green-400 via-green-500 to-green-600 text-white px-8 py-3 text-lg font-semibold rounded-full shadow-lg transform transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50">
